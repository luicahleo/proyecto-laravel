...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <!-- comprobamos si existe sesion 'message' para imprimir un cartel  -->
            @if(session('message'))
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('user.update') }}"  enctype="multipart/form-data"  aria-label="{{ __('Register') }}">
                        @csrf
